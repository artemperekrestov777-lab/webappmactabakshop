...
`;
        ...
        const keyboard = {
            inline_keyboard: [[
                {
                    text: '🛒 Каталог',
                    web_app: { url: 'https://artemperekrestov777-lab.github.io/webappmactabakshop/webapp/index.html' }
                }
            ]]
        };
                            ...
                            inline_keyboard: [[
                                {
                                    ...
                                    web_app: { url: 'https://artemperekrestov777-lab.github.io/webappmactabakshop/webapp/index.html#cart' }
                                }
                            ]]
                        }
                    }
